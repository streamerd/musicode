...
define :movement_one do
  ...
  # Add to Movement 1 for rhythmic foundation
  in_thread do
    8.times do
      use_synth :tb303
      play :C2, release: 0.2, cutoff: 70, amp: 0.3
      sleep 1
      use_synth :pretty_bell
      play :G3, release: 0.1, amp: 0.2
      sleep 1
    end
  end
...
define :movement_two do
  ...
  # Add to Movement 2 for soft accents
  in_thread do
    16.times do
      use_synth :piano
      play_chord [:C4, :E4, :G4], release: 0.3, amp: 0.2
      sleep 2
      use_synth :pluck
      play :E5, release: 0.1, amp: 0.15
      sleep 2
    end
  end
...
define :movement_three do
  ...
  in_thread do
    8.times do
      with_fx :reverb, room: 0.8 do
        sample flutes, ["a3", "flutes-f3"].choose,
          amp: 0.4,
          attack: 0.2,
          release: 1.0
        sleep 2
  ...
  # Add to Movement 3 for excitement
  in_thread do
    24.times do
      use_synth :blade
      play_pattern_timed [:C5, :E5, :G5], [0.25], release: 0.1, amp: 0.2
      sleep 0.25
    end
  end
...
define :finale do
  ...
  # Add to Finale for dramatic effect
  in_thread do
    4.times do
      use_synth :supersaw
      play_chord [:C4, :E4, :G4, :C5], release: 0.5, amp: 0.3
      sleep 4
      3.times do
        use_synth :pretty_bell
        play :C6, release: 0.1, amp: 0.2
        sleep 0.25
      end
      sleep 0.25
    end
